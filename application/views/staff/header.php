  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active"><a href="<?php echo base_url(); ?>"><i ></i> <span>Dashboard</span></a></li>

        <li class="treeview">
          <a href="#">
            <i ></i> <span>Salary</span>
        ...
        <li class="treeview">
          <a href="#">
            <i></i> <span>Certificates</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="<?php echo base_url(); ?>Add-Certificate"><i class="fa fa-circle-o"></i>Add Certificates</a></li>
            <li><a href="<?php echo base_url(); ?>Manage-Certificate"><i class="fa fa-circle-o"></i> Manage Certificates</a></li>
          </ul>
        </li>
        ...
        <li class="treeview">
          <a href="#">
            <i></i> <span>Credentials</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="<?php echo base_url(); ?>Add-Credentials"><i class="fa fa-circle-o"></i>Add Credentials</a></li>
            <li><a href="<?php echo base_url(); ?>Manage-Credentials"><i class="fa fa-circle-o"></i> Manage Credentials</a></li>
          </ul>
        </li>
